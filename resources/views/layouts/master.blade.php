...
window.__h82AlnkH6D91__("");</script>
	...
	<link href="{{ url('assets/plugins/select2/css/select2.min.css') . getPictureVersion() }}" rel="stylesheet">
	<link href="{{ url('assets/plugins/owlcarousel/assets/owl.carousel.min.css') . getPictureVersion() }}" rel="stylesheet">
	<link href="{{ url('assets/plugins/owlcarousel/assets/owl.theme.default.min.css') . getPictureVersion() }}" rel="stylesheet">
...
<script src="{{ url('assets/plugins/select2/js/select2.min.js') . getPictureVersion() }}"></script>
<script src="{{ url('assets/plugins/SocialShare/SocialShare.min.js') . getPictureVersion() }}"></script>
<script src="{{ url('assets/plugins/owlcarousel/owl.carousel.min.js') . getPictureVersion() }}"></script>
@if (config('app.locale') !== 'en' && file_exists(public_path() . '/assets/plugins/select2/js/i18n/'.config('app.locale').'.js'))
...
@endif
<script>
	{{-- Modern Counter Up Alternative --}}
	function modernCounterUp() {
		...
		const observer = new IntersectionObserver((entries) => {
			entries.forEach(entry => {
				if (entry.isIntersecting) {
					...
					const delay = parseInt(counter.getAttribute('data-delay') || '10');
	...
	{{-- Legacy counterUp compatibility - Define immediately --}}
	if (typeof jQuery !== 'undefined') {
		jQuery.fn.counterUp = function(options) {
			options = options || {};
			return this.each(function() {
				const $this = jQuery(this);
				const finalNumber = parseInt($this.text().replace(/[^\d]/g, '')) || 0;
				
				// Set data attributes for our modern counter
				$this.attr('data-counter', finalNumber);
				$this.attr('data-duration', options.time || 2000);
				$this.attr('data-delay', options.delay || 10);
				
				// Reset text to 0 and trigger our modern counter
				$this.text('0');
				
				// Trigger counter with slight delay
				setTimeout(modernCounterUp, 100);
			});
		};
	}
	...
	$(document).ready(function () {
		...
		{{-- Initialize modern counter on page load --}}
		modernCounterUp();
